...
**Status:** Active
**Last updated:** 2026-09-04 (Phase 5 Complete, CL-0052: features CL-0049–0051, reviewer audit run and findings fixed; Alek's hands-on try-out in §5)
...
| 5 | **Animation** | Keyframes (position, scale, rotation, flip, opacity), easing, motion presets, pose swapping, camera pan/zoom, render snapshot checks | **Complete** (CL-0044–0052; reviewer audit run; Alek's try-out in §5) | Fable throughout (Alek's choice, as Phases 3–4) |
...
| Item | Needed by | Ref |
|------|-----------|-----|
| Try the Phase 5 feature half by hand: select a layer and apply each motion preset (Walk's destination clicked on the canvas), Ctrl+Z each away; press Camera, zoom in, pan, move the playhead, change the shot, press ▶; swing the rotate handle above the selection box, Escape one drag mid-turn. | Now (verifies CL-0049–0051, closes Phase 5) | M-4.4, M-4.6, M-4.2 |
