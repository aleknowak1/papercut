...
**Start-up reliability (CL-0021):** the app now waits for its screen server, retries failed loads, and shows a plain-text explanation instead of ever staying blank. If you see that text page, close the window and run `npm run dev` again.
