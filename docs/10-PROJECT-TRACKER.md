...
**Status:** Active
**Last updated:** 2026-09-04 (Phase 6 planned; kickoff prompt in DOC-11 Appendix G, CL-0053)
...
**Next action:** Phase 6 (Timeline and audio) begins with the kickoff prompt in DOC-11 Appendix G (CL-0053): Fable for the foundations (clip trim fields, pure timeline module, previewSchedule, mixer/decoder, export change, checks), then Opus for the timeline UI; decisions a–n already made. Alek verified the Phase 5 feature half by hand on 2026-09-04 (all passed); the kickoff's first commit records that in DOC-04 and clears the §5 row.
