...
| A7 | ONNX Runtime (onnxruntime-node) **1.29.0 (exact, installed)** | Runs BiRefNet locally | MIT | 2026-09-02, repo LICENSE | Reproduce notice. Install facts (DOC-13 §2): Windows binaries ship inside the npm package (postinstall downloads nothing on Windows); all five binaries, including the native `.node` module, are validly **Microsoft-signed** — Smart App Control does not object (OQ-020, DOC-13). | **Cleared** (in use) |
| A8 | BiRefNet_lite and BiRefNet (weights, ONNX) | Background removal | MIT | 2026-09-02, repo LICENSE and HF model card | Reproduce notice. Training data (DIS5K) has separate academic terms; the author's MIT license on the weights governs redistribution, and the model is in wide commercial use. **Provenance:** the author (ZhengPeng7) publishes only PyTorch weights; the ONNX files are conversions of his MIT weights by the onnx-community group on Hugging Face, MIT-licensed. Pinned in scripts/model-manifest.json and verified by SHA-256 on download: lite fp16 = onnx-community/BiRefNet_lite @ de15b22ba131738a16dff04aab8bdf8dc32e3ac1, onnx/model_fp16.onnx, 114 538 221 bytes, sha256 d39b897ceb16ae654c1731f3dba0cf9b368d9cae74b5a57459b455cc8bfec402 (fetched); full fp16 = onnx-community/BiRefNet-ONNX @ 534d3c82d3bb8b2f0867db6dfbc3a525b8e42f67, onnx/model_fp16.onnx, 489 666 272 bytes, sha256 3654c741eb80bd926ada8fed1713b506ccf8d30eb1f6487e87eb9f234f33df09 (pinned, not yet fetched); lite fp32 = onnx-community/BiRefNet_lite @ de15b22ba131738a16dff04aab8bdf8dc32e3ac1, onnx/model.onnx, 224 005 088 bytes, sha256 5600024376f572a557870a5eb0afb1e5961636bef4e1e22132025467d0f03333 (fetched for the DOC-13 §9 measurements, Alek-approved download). **Note:** the fp16 files proved unusably slow on CPU (DOC-13); which format ships (fp32/int8/other) is pending Alek's OQ-020 decision and will be recorded here when made. | **Cleared** (format choice pending, DOC-13 §6) |
